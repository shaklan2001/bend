...
const StreakDay = memo(({
    ...
    return (
        <View className="items-center" style={{ minWidth: 32 }}>
            ...
            >
                {isCompleted && (
                    <Entypo name="check" size={16} color="#FFFFFF" />
                )}
            </View>
        </View>
    );
    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            ...
            >
                ...
                <Text style={streakScreenStyles.congratsText}>
                    Congrats!
                </Text>

                <Text style={streakScreenStyles.completionText}>
                ...
                <View className="mb-8">
                    <Text style={streakScreenStyles.summaryTitle}>
                        ROUTINE SUMMARY
                    </Text>
                    <View className="mt-3">
                ...
                <View className="flex-row gap-4">
                    ...
                    >
                        ...
                        <Text style={streakScreenStyles.shareText}>
                            Share Routine
                        </Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        activeOpacity={0.8}
                    >
                        <Text style={streakScreenStyles.doneText}>
                            DONE
                        </Text>
                    </TouchableOpacity>
                </View>
