        ...
        <View className='flex-row justify-between items-start border-b border-gray-200 pb-4'>
          <View className='flex-1'>
            <Text
              style={[
                ...
                { color: '#9CA3AF', marginBottom: 4, fontWeight: '600' },
              ]}
            >
              {day} {month}
            </Text>
            <Text
              style={[
                FontStyles.heading1,
                { color: '#000000', fontWeight: '700', fontSize: 36, marginTop: 2 },
              ]}
            >
              {dayName}
            </Text>
          ...
          <View className='flex-row items-center space-x-3 gap-2'>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={{ color: '#FFFFFF', fontSize: 12, fontWeight: '600' }}>RESET</Text>
            </TouchableOpacity>
            <TouchableOpacity
