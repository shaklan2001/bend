...
export const SparkleIcon = (props: any) => {
  ...
  return (
    ...
    >
      <Path
        d='M12 0L9.12 7.08L2 7.76L7.17 12.87L5.94 20L12 16.27L18.06 20L16.83 12.87L22 7.76L14.88 7.08L12 0Z'
        fill={fill}
      />
    </Svg>
  );
      ...
      >
        ...
        <Tabs.Screen
          ...
          options={{
            ...
            title: 'Save Library',
            tabBarIcon: ({ focused }) => <BookmarkIcon isFocused={focused} />,
            tabBarShowLabel: false,
          }}
        />
        <Tabs.Screen
          ...
          options={{
            ...
            title: 'Dashboard',
            tabBarIcon: ({ focused }) => <GraphIcon isFocused={focused} />,
            tabBarShowLabel: false,
          }}
        />
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ focused }) => <GearIcon isFocused={focused} />,
            tabBarShowLabel: false,
          }}
        />
      </Tabs>
