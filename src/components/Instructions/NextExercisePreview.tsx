...
export const NextExercisePreview = memo(({ exercise }: NextExercisePreviewProps) => {
    ...
    return (
        ...
        >
            <Text className="text-center mb-2" style={nextExercisePreviewStyles.label}>Up Next</Text>
            ...
            <Text className="text-center" style={nextExercisePreviewStyles.exerciseName} numberOfLines={2}>
                {exercise.name}
            </Text>
        </Animated.View>
    );
