...
export const ExerciseInfoModal = memo(
  ({ visible, exercise, onClose, onPauseTimer }: ExerciseInfoModalProps) => {
          ...
          >
            <SafeAreaView>
              ...
              <View className='flex-row justify-between items-center px-5 pb-5 border-b border-gray-200'>
                <View className='w-8' />
                <Text style={exerciseInfoModalStyles.headerTitle}>Exercise Info</Text>
                <TouchableOpacity
              ...
              <ScrollView className='p-5' showsVerticalScrollIndicator={false}>
                {exercise.video_url ? (
                  ...
                  <View className='bg-gray-50 rounded-xl p-4 mt-2.5 min-h-[60px] justify-center items-center'>
                    <Text style={exerciseInfoModalStyles.noVideoText}>No video</Text>
                  </View>
                )}
                <Text style={exerciseInfoModalStyles.exerciseName}>{exercise.name}</Text>

                <Text style={exerciseInfoModalStyles.sectionTitle}>Description</Text>
                <Text style={exerciseInfoModalStyles.description}>{exercise.description}</Text>
              </ScrollView>
            </SafeAreaView>
          </View>
        </View>
